...
def edit_expense():
	...
	edit_btn = Button(data_entry_frame, text='Edit expense', font='Georgia', width=30,
...
dataentery_frame_bg = '#F7E2E2'
buttons_frame_bg = '#61A4BC'
hlb_btn_bg = '#ffffff'
...
root = Tk()
root.title('Py_coder_hub Expense Tracker')
root.geometry('1200x550')
root.resizable(0, 0)

Label(root, text='EXPENSE TRACKER', font=('Helvetica', 15, 'bold'), bg=hlb_btn_bg).pack(side=TOP, fill=X)
...
dd1 = OptionMenu(data_entry_frame, MoP, *['Cash', 'Cheque', 'Credit Card', 'Debit Card', 'UPI Payment', 'PayPal'])
